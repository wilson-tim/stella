CREATE OR REPLACE AND COMPILE JAVA SOURCE NAMED "TimSandbox" AS
...
SELECT TIMFPRECORD('FPO/NONREFAGTX;P3') FROM DUAL;
SELECT TIMFPRECORD('FPNONREFAGTL1156746/GBP1469.64') FROM DUAL;
SELECT TIMFPRECORD('FPNONREFAGTL1156746/GBP1469.64') FROM DUAL;
SELECT TIMFPRECORD('FPO/NONREFAGT+/NONREFAGT/GBP690.00') FROM DUAL;
SELECT TIMFPRECORD('FPO/NONREFAGTZ1165511+/NONREFAGT/GBP3004.90') FROM DUAL;
SELECT TIMFPRECORD('FPO/NONREFAGTZ1150135/+/NONREFAGT/GBP197.00;S7-8;P1-2') FROM DUAL;
SELECT TIMFPRECORD('FPO/NONREFAGTZZ1165511+/NONREFAGT/GBP3004.90') FROM DUAL;
SELECT TIMFPRECORD('FPO/NONREFAGTZZ1150135/+/NONREFAGT/GBP197.00;S7-8;P1-2') FROM DUAL;
...
SELECT TIMCOLLAMTRECORD('FPNONREFAGTL1156746/GBP1469.64') FROM DUAL;
SELECT TIMCOLLAMTRECORD('FPO/NONREFAGT+/NONREFAGT/GBP690.00') FROM DUAL;
SELECT TIMCOLLAMTRECORD('FPO/NONREFAGTZ1165511+/NONREFAGT/GBP3004.90') FROM DUAL;
SELECT TIMCOLLAMTRECORD('FPO/NONREFAGTZ1150135/+/NONREFAGT/GBP197.00;S7-8;P1-2') FROM DUAL;
SELECT TIMCOLLAMTRECORD('FPO/NONREFAGTZZ1165511+/NONREFAGT/GBP3004.90') FROM DUAL;
SELECT TIMCOLLAMTRECORD('FPO/NONREFAGTZZ1150135/+/NONREFAGT/GBP197.00;S7-8;P1-2') FROM DUAL;
...
SELECT TIMEXCHTKTRECORD('FO006-2570769969-70LON24MAY18/91212295/006-25707699694E1234*I;S4-8;P3') FROM DUAL;
