...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//	This program will perform a get to a socket/port of a web server and save the
// retrieved output to
//	a file of your choice, or display to the standard output stream. The header
// of the request is always
...
//      10/07/02 jwj Changed the output to a Buffered writer to cope with large
// documents
//      02/10/03 AJ Moved to UTIL package on instructions of L.Ashton
//      02/10/03 AJ Class renamed to Http2File to match file name and made public.
//
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			if ((args.length < 3) == true) {
				throw new Exception(
						"you need to pass the manditory parameters : IP Port URL (filename)");
			}
			...
			//argument 2 of the command line is the Port that we want to
			// retrieve
			//argument 3 of the command line is the URL that we want to
			// retrieve
			//argument 4 of the command line is the File that we want to write
			...
			try {
				...
				throw new Exception("failed to open socket on ip " + ip
						+ " and port " + port);
			}
			...
			try {
				...
				//conn.shutdownOutput(); // later version of java required 1.3
				// up
				...
				//create a data reader that is limited in size (to overcome
				// memory problems)
				...
				//conn.shutdownInput(); // later version of java required 1.3
				// up
