...
/**
 * This is a pooled database connection for JVM V1.2 and 1.3.
 * <p>
 */

public abstract class PooledConnection12 extends BasePooledConnection implements
		Resource, Connection {

	public PooledConnection12() {
	}

	public PooledConnection12(Properties props) throws ResourceException {
		super(props);
	}
