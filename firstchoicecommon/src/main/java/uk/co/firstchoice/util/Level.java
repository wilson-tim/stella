...
public class Level implements java.io.Serializable {
		...
		synchronized (Level.class) {
			for (int i = 0; i < known.size(); i++) {
				...
				if (this.name.equals(other.name)
						...
						&& (this.resourceBundleName == other.resourceBundleName || (this.resourceBundleName != null && this.resourceBundleName
	 ...
	 *             if the value is neither one of the known names nor an
	 *             integer.
	 */
