...
/**
 * Provides a generic exception for applications that will retain and provide
 * information about the underlying exception. <BR>
 * 
...
public abstract class ApplicationException extends Exception implements
    ...
    protected ApplicationException(String message, Throwable t) {
        super(message);
